...
// Universe is two-dimensional field of cells.
type Universe [][]bool
...
// Alive reports wheter the specified cell is alive.
// If the coordinate are outside of the universe, they wrap around.
...
// Neighboors counts the adjacent cells that are alive.
