...
var (
	...
	ErrInRow      = errors.New("digit already presented in this row")
	ErrInColumn   = errors.New("digit already presented in this column")
	ErrInRegion   = errors.New("digit already presented in this region")
